defmodule EricApi.PromEx do
  ...
  1. Update your configuration (config.exs, dev.exs, prod.exs, releases.exs, etc) to
     ...
     ```
     config :eric_api, EricApi.PromEx,
       disabled: false,
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule EricApiWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :eric_api

       ...

       plug PromEx.Plug, prom_ex_module: EricApi.PromEx
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam
      # {Plugins.Phoenix, router: EricApiWeb.Router, endpoint: EricApiWeb.Endpoint},
      # Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:eric_api, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
